	...
	<div id="anuncioscuadro2">
		...
		<div id="anuncios_contenido2">   
			<div style="margin:100px;margin-left:50px;">
					<form action="phpeliminausuario.php" method="GET">				
						<table style="width:520px" border="5">
							<caption style="font-weight: bold;font-size:25px;">Eliminar Persona</caption>
							<tr>
							...
							<tr>
								<td colspan="2" align="center">
									<input type="submit" value="Esta seguro de eliminar ?">
								</td>
							</tr>
						</table>
					</form> 	
